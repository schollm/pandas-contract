...
## [Upcoming]
### Changes
* Migrate from `make` to `poe`.
### Fixed
* Detect changes when columns with identical labels are added or removed.
* CheckSchema never changes the DataFrame in-place.
...
## [0.11.0]
### Changed
- Move _lib.ValidateDictT to _decorator
- Use pandera.pandas imports instead of pandera directly.
